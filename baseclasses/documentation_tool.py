 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    }\\n",
    "    g1 = Grid(grid_data=samples,grid_options=grid_options,show_toggle_edit=True,sync_on_edit=True,theme='ag-theme-balham',columns_fit='auto',index=False)\\n",
    "    grid_options.update({'columnDefs':[{'headername':c,'field': c} for c in envs.columns]})\\n",
    "    g2 = Grid(grid_data=envs,grid_options=grid_options,show_toggle_edit=True,sync_on_edit=True,theme='ag-theme-balham',columns_fit='auto',index=False)\\n",
    "    grid_options.update({'columnDefs':[{'headername':c,'field': c} for c in setups.columns]})\\n",
    "    g3 = Grid(grid_data=setups,grid_options=grid_options,show_toggle_edit=True,sync_on_edit=True,theme='ag-theme-balham',columns_fit='auto',index=False)\\n",
    "    data = {\\"samples\\":g1,\\n",
    "            \\"envs\\":g2,\\n",
    "            \\"setups\\":g3\\n",
    "       } \\n",
    ...
    "    out2.clear_output()\\n",
    "    with out2:\\n",
    "        print(\\"creating entries (takes about 35 sec)\\")\\n",

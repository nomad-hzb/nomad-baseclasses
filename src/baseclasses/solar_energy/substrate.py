...
class Substrate(Entity):
    ...
    def normalize(self, archive, logger):
        ...
        if self.substrate:
            ...
            archive.results.properties.optoelectronic.solar_cell.substrate = substrate_materials
            ...
            if self.substrate_properties:
                ...
                if hasattr(self.substrate_properties, 'layer_thickness') and self.substrate_properties.layer_thickness is not None:
                    props['thickness'] = self.substrate_properties.layer_thickness
                    
                if hasattr(self.substrate_properties, 'layer_transmission') and self.substrate_properties.layer_transmission is not None:
                    props['transmission'] = self.substrate_properties.layer_transmission
                    
                if hasattr(self.substrate_properties, 'sheet_resistance') and self.substrate_properties.layer_sheet_resistance is not None:
                    props['sheet_resistance'] = self.substrate_properties.sheet_resistance
